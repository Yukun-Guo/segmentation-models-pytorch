...
regnet_weights = {
    "timm-gernet_s": {
        "imagenet":
        "https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-ger-weights/gernet_s-756b4751.pth",  # noqa
    },
    "timm-gernet_m": {
        "imagenet":
        "https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-ger-weights/gernet_m-0873c53a.pth",  # noqa
    },
    "timm-gernet_l": {
        "imagenet":
        "https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-ger-weights/gernet_l-f31e2e8d.pth",  # noqa
    },
}
        ...
        "params": {
            ...
            ByoModelCfg(
                blocks=(
                    ...
                    ByoBlockCfg(type="bottle", d=7, c=384, s=2, gs=0,
                                br=1 / 4),
        ...
        "params": {
            ...
            ByoModelCfg(
                blocks=(
                    ...
                    ByoBlockCfg(type="bottle", d=6, c=640, s=2, gs=0,
                                br=1 / 4),
