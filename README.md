This repository is created for the purpose of personal learning and sharing. It is not intended to be used as a reference for any other purpose.
--------
This README is from the orignal repository. It is not up to date. Please refer to [qubvel/segmentation_models.pytorch](https://github.com/qubvel/segmentation_models.pytorch) for the latest information.
<div align="center">
